...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  useEffect(() => {
    ...
    m.color = new Color(defaultProps.globeColor);
    m.emissive = new Color(defaultProps.emissive);
    m.emissiveIntensity = defaultProps.emissiveIntensity;
    m.shininess = defaultProps.shininess;
  }, [isInitialized]);
...
export function World(props: WorldProps) {
  ...
  scene.fog = new Fog(0x1a1a1a, 400, 2000);
  return (
    <Canvas
      scene={scene}
